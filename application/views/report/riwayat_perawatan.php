...
<!-- Isi -->
    ...
    Maintenance
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="<?php echo base_url('report/riwayat_perawatan')?>">Riwayat Perawatan</a>
        </div>
        </div>
    </li>
...
<div id="content">
    ...
    <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="<?php echo base_url().'report/get_riwayat_perawatan'?>" method="post">
                <table>
                <tr>
                <td>
