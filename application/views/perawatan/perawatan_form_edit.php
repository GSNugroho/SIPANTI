...
<html>
    ...
    <body>
        ...
        <div class="form-group">
			...
			<input class="form-control" type="text" name="vc_no_inv" id="vc_no_inv" placeholder="Nomor Inventaris" onclick="div_show() " value="<?php echo $vc_no_inv;?>" disabled>
        </div>
        </td>
        <td></td>
        <td>
		<div class="form-group">
            ...
            <input class="form-control" type="date" name="dt_mulai" id="dt_mulai" placeholder="Tanggal Pengerjaan" value="<?php echo $dt_mulai;?>">
        </div>
        </td>
        </tr>
        <tr>
		...
		<div class="form-group">
            ...
            <input class="form-control" type="date" name="dt_selesai" id="dt_selesai" placeholder="Tanggal Selesai" value="<?php echo $dt_selesai;?>">
		</div>
        </td>	
        <td></td>
        <td>        
		<div class="form-group">
            ...
            <input class="form-control" type="text" name="vc_nm_tindakan" id="vc_nm_tindakan" placeholder="Tindakan" value="<?php echo $vc_nm_tindakan;?>">
		</div>
        </td>
        </tr>
        <tr>
