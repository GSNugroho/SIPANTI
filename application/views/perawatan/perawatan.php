...
<div class="card shadow mb-4">
		...
		<!-- <div class="btn btn-success btn-icon-split">
			...
			?>
						...
						<div class="btn btn-danger btn-icon-split">
							<?php //echo $this->session->userdata('messages') <> '' ? $this->session->userdata('messages') : ''; 
							?>
						</div> -->
		<?php
	...
	<div class="card-body">
		<!-- <a href="<?php //echo base_url('perawatan/komponen')
...
<!-- <script src="<?php //echo base_url('assets/dist/sweetalert.js') 
					?>"></script> -->
